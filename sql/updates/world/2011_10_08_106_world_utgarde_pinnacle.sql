...
-- Ritual teleports
INSERT IGNORE INTO `spell_target_position` (`id`, `target_map`, `target_position_x`, `target_position_y`, `target_position_z`, `target_orientation`) values('48267','575','296.632','-346.075','90.547','4.60767');
INSERT IGNORE INTO `spell_target_position` (`id`, `target_map`, `target_position_x`, `target_position_y`, `target_position_z`, `target_orientation`) values('48276','575','296.632','-346.075','113.547','4.60767');
...
('26668','-1575027','Any last words?','¿Tus últimas palabras?','¿Tus últimas palabras?','13854','1','svala SAY_SACRIFICE_5'),
('26668','-1575026','Yor-guul mak!','¡Yor-guul mak!','¡Yor-guul mak!','13853','1','svala SAY_SACRIFICE_4'),
...
('26668','-1575022','Nooo! I did not come this far... to...','¡Nooo! No he llegado tan lejos... para...','¡Nooo! No he llegado tan lejos... para...','13855','1','Svala Sorrowgrave SAY_DEATH'),
...
('26668','-1575019','You were a fool to challenge the power of the Lich King!','¡Que estupidez desafiar el poder del Rey Exánime!','¡Que estupidez desafiar el poder del Rey Exánime!','13845','1','Svala Sorrowgrave SAY_SLAY_1'),
('26668','-1575018','I will vanquish your soul!','¡Someteré vuestra alma!','¡Someteré vuestra alma!','13842','1','Svala Sorrowgrave SAY_AGGRO'),
('29281','-1575017','I will be happy to slaughter them in your name! Come, enemies of the Scourge! I will show you the might of the Lich King!','¡Será un placer matarlos en vuestro nombre! ¡Acercaos, enemigos de la Plaga! ¡Os enseñaré el poder del Rey Exánime!','¡Será un placer matarlos en vuestro nombre! ¡Acercaos, enemigos de la Plaga! ¡Os enseñaré el poder del Rey Exánime!','13858','1','Svala Sorrowgrave SAY_DIALOG_WITH_ARTHAS_3'),
...
('29281','-1575015','My liege! I have done as you asked, and now beseech you for your blessing!','¡Mi señor! ¡He hecho lo que pediste, y ahora suplico vuestra bendición!','¡Mi señor! ¡He hecho lo que pediste, y ahora suplico vuestra bendición!','13856','1','Svala Sorrowgrave SAY_DIALOG_WITH_ARTHAS_1');
