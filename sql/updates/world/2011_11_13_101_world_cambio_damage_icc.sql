...
-- Rotface
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '30.5' WHERE `entry` =36627;-- Valor Anterior 35
-- 36899 Bigg Ozze
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '9.5' WHERE  `entry` =36899;-- Valor Anterior 7.5
-- Festergut
UPDATE `creature_template` SET  `mindmg` =  '1509',`maxdmg` =  '2683',`dmg_multiplier` =  '28.5' WHERE `entry` =36626;-- Valor Anterior 35
-- Sister Svalna
